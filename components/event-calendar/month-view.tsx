...
export function MonthView({
  ...
  const hasPastIncomplete = useMemo(() => {
    ...
    return events.some(
      (event) => !event.completed && new Date(event.start) < calendarStart
    )
  }, [events, calendarStart])
                ...
                >
                  ...
                  >
                    ...
                    <div
                      ...
                      className="min-h-[calc((var(--event-height)+var(--event-gap))*2)] sm:min-h-[calc((var(--event-height)+var(--event-gap))*3)] lg:min-h-[calc((var(--event-height)/2+var(--event-gap))*4)]"
                    >
