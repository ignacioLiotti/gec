  ...
  return (
    <>
      <DropdownMenu>
        <DropdownMenuTrigger
          className={cn(
            "flex size-full items-center justify-between gap-2 px-2 py-1 text-xs hover:bg-accent/40 data-[state=open]:bg-accent/40 [&_svg]:size-3",
            ...
            {columnVariant && (
              <Tooltip delayDuration={100}>
                <TooltipTrigger asChild>
                  <columnVariant.icon className="size-2.5 shrink-0 text-muted-foreground" />
                </TooltipTrigger>
