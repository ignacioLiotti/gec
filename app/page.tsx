            ...
            <div className="w-full md:w-[40%] border-b md:border-b-0 md:border-r border-stone-200/70 p-6 md:p-12 flex flex-col justify-center overflow-hidden">
              ...
              <div className="flex flex-col">
                {steps.map((step, idx) => {
                  ...
                  return (
                    <m.div key={step.id} layout transition={{ duration: 0.18, ease: "easeInOut" }} className="flex gap-3 md:gap-4">
              ...
              <div className="w-full md:w-[40%] p-5 md:p-12 flex flex-col justify-center overflow-hidden">
                ...
                <div className="flex flex-col">
                  {benefits.map((benefit, idx) => {
                    ...
                    return (
                      <m.div key={benefit.title} layout transition={{ duration: 0.18, ease: "easeInOut" }} className="flex gap-3 md:gap-4 cursor-pointer">
