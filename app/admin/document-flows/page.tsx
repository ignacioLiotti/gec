          ...
          <div className="border-b border-stone-200 bg-[linear-gradient(180deg,#fffdf9_0%,#f9f6ef_100%)] px-6 py-5">
            <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
              <div className="space-y-3">
                ...
                <div>
                  <h1 className="text-3xl font-semibold tracking-tight text-stone-950">Configuracion documental</h1>
                  <p className="mt-2 max-w-3xl text-sm leading-6 text-stone-600">
                    Cuando en la organizacion exista una carpeta de este tipo, los documentos cargados ahi deben extraer cierta informacion, materializar tablas y opcionalmente alimentar macrotablas generales.
                  </p>
                </div>
              </div>
          ...
          <div className="grid gap-4 px-6 py-5 lg:grid-cols-[minmax(0,1fr)_360px]">
            ...
            <aside className="space-y-4">
              <div className="rounded-[28px] border border-stone-200 bg-white p-4 shadow-sm">
                <p className="text-sm font-semibold text-stone-950">Estado del slice</p>
                <p className="mt-1 text-xs text-stone-500">
                  Esta pagina usa el contrato real del tenant y traslada la edicion al inspector flotante.
                </p>
