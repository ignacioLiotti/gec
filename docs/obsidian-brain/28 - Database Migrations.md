...
### Phase 8 - Demo, Soft Delete, Data Flow & Document Generation (0087-0103)
...
| 0103 | `admin_config_permissions.sql` | Adds delegated admin permissions for Configuracion de Obras and Tabla Principal |
