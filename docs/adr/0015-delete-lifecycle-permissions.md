...
Accepted; file-delete permission enforcement superseded by ADR 0026
...
- `supabase/migrations/0122_document_purge_permission.sql`
- `docs/obsidian-brain/20 - Permissions System.md`
- `docs/obsidian-brain/38 - Soft Delete Pattern.md`
- `docs/adr/0026-authenticated-document-file-delete.md`
